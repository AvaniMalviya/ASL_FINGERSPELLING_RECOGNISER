...
if __name__ == "__main__":
    DEFAULT_TRAIN_FILEPATH = "resources/data/train_landmarks_npy/{}.npy"
    DEFAULT_TRAIN_LABEL_PATH = "resources/data/train.csv"
    DEFAULT_SUPP_FILEPATH = "resources/data/supplemental_landmarks_npy/{}.npy"
    DEFAULT_SUPP_LABEL_PATH = "resources/data/supplemental_metadata.csv"
    DEFAULT_ALIGNMENTS_PATH = "resources/data/alignments.csv"
    DEFAULT_VOCAB_PATH = "resources/data/character_to_prediction_index.json"
